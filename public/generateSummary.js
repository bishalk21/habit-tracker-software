...
import { calculateTokens, ChatView } from "./ce.js";
import { makeSummary, splitForSummary } from "./summary.js";
...
async function handleUserMessage(event) {
  ...
  let contextTokens = calculateTokens(contextMessages);
  if (contextTokens > MAX_TOKENS) {
    ...
    const summaryMessage = await makeSummary(
      messagesToSummarize,
      openRouterModel,
    );
