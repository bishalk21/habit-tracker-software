...
const createHFTokenBtn = document.getElementById("create-hf-token");

// Create HF Token button click event
createHFTokenBtn.addEventListener("click", async () => {
  try {
    const response = await fetch("/api/hfFunction");
    if (!response.ok) {
      throw new Error("Failed to call Hugging Face function");
      return;
    }
    const data = await response.json();
    console.log("Hugging Face function response:", data);
    alert(
      "Hugging Face function called successfully. Check console for details.",
    );
  } catch (error) {
    console.error("Error calling Hugging Face function:", error);
    alert("Error calling Hugging Face function. Check console for details.");
  }
});

// Generate Text button click event
...
generateTextBtn.addEventListener("click", async () => {
  try {
    ...
    alert("Text generated successfully. Check console for details.");
  } catch (error) {
    console.error("Error generating text:", error);
    alert("Error generating text. Check console for details.");
  }
});
